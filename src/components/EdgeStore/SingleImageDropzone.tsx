        ...
        >
          ...
          {imageUrl ? (
            ...
            <div className="flex flex-col items-center justify-center text-xs bbb-400">
              ...
              <div className="bbb-400">drag & drop to upload</div>
              <div className="mt-3">
  ...
  return (
    <button
      className={twMerge(
        ...
        // color
        'border border-gray-400 bbb-400 shadow hover:bg-gray-100 hover:aaa dark:border-gray-600 dark:text-gray-100 dark:hover:bg-gray-700',
        // size
