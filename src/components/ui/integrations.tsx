            ...
            <div className="flex h-full w-full flex-row items-stretch justify-between gap-10">
                ...
                <div className="flex flex-col justify-center">
                    <Circle ref={div6Ref} className="h-16 w-16">
                        <Image src="/brightveilLight.jpeg" alt="plateform Image" height={20} width={20} className="h-10 w-10 rounded-full" />
                    </Circle>
                </div>
...
const Icons = {
    ...
    AI: (props: LucideProps) => (
        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="50" viewBox="0 0 48 48">
            <path d="M31.5 41c-.651 0-1.229-.421-1.428-1.041l-2.927-9.104-9.104-2.927C17.421 27.729 17 27.151 17 26.5s.421-1.229 1.041-1.428l9.104-2.927 2.927-9.104C30.271 12.421 30.849 12 31.5 12s1.229.421 1.428 1.041l2.927 9.104 9.104 2.927C45.579 25.271 46 25.849 46 26.5s-.421 1.229-1.041 1.428l-9.104 2.927-2.927 9.104C32.729 40.579 32.151 41 31.5 41zM12 23c-.646 0-1.219-.413-1.423-1.025l-1.888-5.664-5.664-1.888C2.413 14.219 2 13.646 2 13s.413-1.219 1.025-1.423l5.664-1.888 1.888-5.664C10.781 3.413 11.354 3 12 3s1.219.413 1.423 1.025l1.888 5.664 5.664 1.888C21.587 11.781 22 12.354 22 13s-.413 1.219-1.025 1.423l-5.664 1.888-1.888 5.664C13.219 22.587 12.646 23 12 23zM10.5 45c-.646 0-1.219-.413-1.423-1.025l-1.514-4.539-4.538-1.513C2.413 37.719 2 37.146 2 36.5s.413-1.219 1.025-1.423l4.538-1.513 1.514-4.539C9.281 28.413 9.854 28 10.5 28l0 0c.646 0 1.219.413 1.423 1.025l1.513 4.539 4.539 1.513C18.587 35.281 19 35.854 19 36.5s-.413 1.219-1.025 1.423l-4.539 1.513-1.513 4.539C11.719 44.587 11.146 45 10.5 45z"></path>
        </svg>
    ),
