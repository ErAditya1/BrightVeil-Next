...
export default function QuizThumbnailForm({ thumbnail }: any) {
    ...
    useEffect(() => setFileUrl(thumbnail?.url), [thumbnail]);
    ...
    const uploadImage = async () => {
        ...
        if (file) {
            ...
            try {
                ...
                const res = await api.patch(`/v1/quiz/thumbnail/${quiz_id}`, formData,
