...
import QuizForm from '@/app/(dashboard)/(routes)/(courses)/components/quiz/QuizAddForm'
                    ...
                    <div className='w-full'>
                        ...
                        <div className='grid md:grid-cols-2 gap-4 p-4 w-full '>
                            ...
                            <div className="flex flex-col  gap-2">
                                ...
                                <div className="flex flex-row justify-between">
                                    <span className="text-md mx-2 flex"><BookMarkedIcon /> Quizes</span ><span className="text-md mx-2 flex cursor-pointer " onClick={() => setAddQuiz(!addQuiz)}><PlusCircle /> Add Quiz</span>
                                </div>
                                {

                                    addQuiz && <QuizForm setCourseData={setCourseData} setAddQuiz={setAddQuiz} />
                                }
                                <div className=" m-2 border p-2 rounded">
                                    <span className="text-md mx-2 flex"> <FileAxis3DIcon />Course Attachments</span>
                                    <div className='m-2'>
